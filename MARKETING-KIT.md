...
2. Activate the FormSubmit email in `bookings@miamipapanoel.com`, then submit one booking test.
...
6. Use `business/email-form-finish.md` to verify the live FormSubmit route to `bookings@miamipapanoel.com`.
